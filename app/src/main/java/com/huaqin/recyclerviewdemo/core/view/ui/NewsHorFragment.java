...
public class NewsHorFragment extends BaseFragment implements NewsContract.View {

    @BindView(R.id.news_recyclerview)
    RecyclerView mRecyclerview;

    private static NewsHorFragment fragment = null;
    Unbinder unbinder;
    ...
    public static NewsHorFragment newInstance() {
        if (fragment == null) {
            fragment = new NewsHorFragment();
        }
        return fragment;
    }
